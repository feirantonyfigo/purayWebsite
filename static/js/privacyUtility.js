...
function myFunction() {
  ...
  if(window.pageYOffset >= stickyLeftMenu-160 && window.pageYOffset < 5800){
  ...
  }else if(window.pageYOffset < stickyLeftMenu-160 ){
  ...
  if (window.pageYOffset >= 5800) {
    ...
    leftMenu.style.transform = 'translateY(5800px)';
  }else{
    leftMenu.classList.add("stickyLeftMenu");
  }
}
